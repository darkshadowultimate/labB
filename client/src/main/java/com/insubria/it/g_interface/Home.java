...
public class Home {
  private static final String[] BUTTONS_TEXTS = { "Organizza Partita", "Visualizza Partite", "Modifica Profilo",
      "Analizza Statistiche" };
  private static final String TITLE_WINDOW = "Il Paroliere - Home";
  private static final String MAIN_TITLE = String.format("Ciao %s, benvenuto nel Paroliere",
      PlayerContextProvider.getEmail());
