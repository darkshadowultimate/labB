package com.insubria.it.paroliere.g_components;
...
public class GridFrame extends GraphicComponent {
  ...
  public void addToView(GraphicComponent component) {
    // check the instance of 'component' and call 'getGraphicComponent' method to retrive a JComponent
  ...
  // Configure the JFrame's options and open the window with the components inside the 'container' field
