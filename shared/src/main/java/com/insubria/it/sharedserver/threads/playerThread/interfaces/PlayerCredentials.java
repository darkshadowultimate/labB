package com.insubria.it.sharedserver.threads.playerThread.interfaces;

import java.rmi.Remote;
import java.rmi.RemoteException;

/**
 * The PlayerCredentials interface defines the remote methods that the instance
 * on the client side will define. It extends the Remote interface because all
 * the methods are remote and defined client side. This is the interface used by
 * the PlayerThread to communicate with the client that made the request.
 */
public interface PlayerCredentials extends Remote {
    /**
     * The signature of the confirmPlayerRegistration method Called when the
     * registration of a new user is okay It is implemented client side
     */
    void confirmPlayerRegistration() throws RemoteException;

    /**
     * The signature of the errorPlayerRegistration method Called when the
     * registration of a new user didn't go well It is implemented client side
     */
    void errorPlayerRegistration(String reason) throws RemoteException;

    /**
     * The signature of the confirmCodeConfirmation method Called when the
     * confirmation of a new user is okay It is implemented client side
     */
