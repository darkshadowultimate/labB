package com.insubria.it.sharedserver.threads.gameThread.utils;

import java.io.Serializable;

/**
 * This class is an util class that will be used to send words discovere on each
 * game. Each of the instance of the WordRecord class will represent a word
 * discovere, with the username of the user that discovered it and the score
 * reached by the word. This class is serializable.
 */
public class WordRecord implements Serializable {
    ...
    public String getReason() {
        return (this.reasonRefused == null) ? "" : this.reasonRefused;
    }
}
