package com.insubria.it.paroliere.threads.playerThread;


import com.insubria.it.paroliere.base.abstracts.Database;
import com.insubria.it.paroliere.base.classes.JavaMailController;
import com.insubria.it.paroliere.base.interfaces.JavaMail;

import com.insubria.it.paroliere.org.mindrot.jbcrypt.BCrypt;

import com.insubria.it.paroliere.threads.playerThread.abstracts.Player;
import com.insubria.it.paroliere.threads.playerThread.interfaces.PlayerCredentials;
...
/**
 * The PlayerThread class represents the thread that will be created for each reuqest made by the user that represents a player handle request (login, registration, data change, password etc).
 * This class extends the Player abstract class that contains the signatures of the methods.
...
public class PlayerThread extends Player implements Runnable {
    ...
    /**
     * Constructor called by the ServerImpl when a user perform a confirmation of his account
     * 
    ...
    /**
     * Constructor called by the ServerImpl when a user performs the change of his data
     * 
     * @param name - The name of the new user
     * @param surname - The surname of the new user
     * @param username - The username of the new user
    ...
    /**
     * This is an utility method invoked when a user needs to be registered. It checks that none of other users have same email and username
     * 
     * @param email - The email of the new user
     * @param username - The username of the new user
    ...
    /**
     * This is an utility method that checks whether a user confirmed his account or not
     * 
     * @param email - The email of the user
     * @param dbConnection - The reference to the Connection object
     * 
    ...
    /**
     * This is an utility method that will perform a delete on the DB to delete a user
     * 
     * @param email - The email of the user
     * @param dbConnection - The reference to the Connection object
     * 
    ...
    /**
     * This is the method called when a new registration needs to be handled. It will handle the process of the creation of a new user for the platform
     * 
     * @param name - The name of the new user
     * @param surname - The surname of the new user
     * @param username - The username of the new user
     ...
     * @param player - The reference to the remote object that represents the client (user) that made the request
     * 
     * @throws InterruptedException - If the thread is interrupted when sleeping, it throws InterruptedException
     ...
     * @throws MessagingException - If there is an error while the sending of the email, it throws MessagingException
     */
    ...
    /**
     * This is the method called when the user confirmation flow needs to be handled.
     * 
     * @param confirmationCode - The confirmationCode to look for in the DB to reach the user that confirmed the account
     * @param player - The reference to the remote object that represents the client (user) that made the request
     * 
     * @throws RemoteException - If there is an error while the client contact, it throws RemoteException
     * @throws SQLException - If there is an error while the DB operations, it throws SQLException
    ...
    /**
     * This is the method called when a user needs to perform login. It will handle the login flow.
     * 
     * @param email - The email of the user
     * @param password - The password of the user
     * @param player - The reference to the remote object that represents the client (user) that made the request
    ...
    /**
     * This is the methdo called when a user needs to reset the password. It will handle the reset password flow.
     * 
    ...
    /**
     * This is an utility method used when the user needs to change the password. It checkes that the old pw is equals to the one the user specified
     * 
    ...
    /**
     * This is the method called when the user needs to change his data. It will handle the change flow.
     * 
     * @param name - The name of the new user
     * @param surname - The surname of the new user
     * @param username - The username of the new user
