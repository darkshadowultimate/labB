...
/**
 * The DatabaseController class represents the class where all the methods needed to interact with the database are defined.
 * The DatabaseController class extends the Database abstract class and defines its methods.
 * 
 * The instances of this class will be used by other objects to interact with the database (both to create/update/delete and query data).
 */
public class DatabaseController extends Database {
  ...
  /**
   * Constructor that will set the host, username, and password attributes for the object created
   * 
  ...
  /**
   * This method creates a connection to the database that will be used to perform operations.
   * This method is invoked by all the objects that needs to perform DB operations.
   * 
   * @return The Connection object
   * @throws SQLException - If a SQLException occurs while the creation of the connection, this will be thrown to the caller
   */
  ...
  /**
   * This method will execute the SQL query passed as an argument.
   * The object that calls this method only needs to define the SQL query and pass it (as a string).
   * 
   ...
   * The object that calls this method will need to cerate the PreparedStatement object and pass it to the method.
   * 
   * @return Nothing
