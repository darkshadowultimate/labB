package com.insubria.it.paroliere.threads.monitorThread.abstracts;
...
/**
 * The abstract class Monitor defines the signatures of the methods that will be defined and available only in the MonitorThread class (because of the protected visibility).
...
public abstract class Monitor {
     ...
     * This method is defined in the MonitorThread class
     */
