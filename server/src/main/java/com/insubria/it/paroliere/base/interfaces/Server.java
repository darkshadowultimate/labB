package com.insubria.it.paroliere.base.interfaces;


import com.insubria.it.paroliere.threads.playerThread.interfaces.PlayerCredentials;
import com.insubria.it.paroliere.threads.monitorThread.interfaces.MonitorClient;
...
/**
 * The interface Server defines the signatures of the methods that will be defined in the ServerImpl class.
 * It extends the Remote interface because the methods will be called by the client using RMI
 */
public interface Server extends Remote {
  /**
   * The signature of the createPlayerAccount method.
   * This method is defined in the ServerImpl class
   */
  ...
  /**
   * The signature of the getListOfGames method.
   * This method is defined in the ServerImpl class
   */
    void getListOfGames (MonitorClient monitorClient, String status) throws RemoteException;

  /**
   * The signature of the getListOfPlayersForGame method.
   * This method is defined in the ServerImpl class
   */
