...
import com.insubria.it.paroliere.base.classes.AccessController;

import com.insubria.it.paroliere.threads.playerThread.PlayerThread;
import com.insubria.it.paroliere.threads.playerThread.interfaces.PlayerCredentials;
import com.insubria.it.paroliere.threads.monitorThread.MonitorThread;
...
/**
 * The ServerImpl class implements the Server class and extends the UnicastRemoteObject class.
...
public class ServerImpl extends UnicastRemoteObject implements Server {
  ...
  public static void main (String[] args) throws RemoteException {
    ...
    try {
      ...
      System.err.println("Error while starting the com.insubria.it.paroliere");
      System.exit(1);
    }
  }
}
